...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
     ...
     <div class="card" style="width:100%; height:350px;" >
      ...
      <div class="card-img-overlay">
        ...
        <p class="card-text" style=" color:rgb(98,186,187);">„Св. Наум Охридски"
        </p>
    ...
    include('db/connection.php');
     $query1 =mysqli_query($conn,"select * from news order by id asc limit 1,2 ");
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-8 blog-main">
          <h3 style="width: 57vw;" class="pb-3 mb-4 font-italic border-bottom">
          </h3>
        ...
        $query=mysqli_query($conn,"select * from news where id='$id'  ");
         while($row=mysqli_fetch_array($query)){
          ...
          <div class="blog-post">
            ...
            <p><img class="img img-thumbnail" style="height: 10%; margin-left: 25%;" src="news/images/<?php echo $thumbnail;?>"  > </p>
            <hr style="width: 57vw;">
